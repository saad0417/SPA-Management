  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: [
          "radial-gradient(circle at 50% 8%, rgba(0,0,0,0) 0%, rgba(0,0,0,0.55) 80%)",
          "linear-gradient(335deg, #16335e 23px, transparent 23px)",
          "linear-gradient(155deg, #16335e 23px, transparent 23px)",
          "linear-gradient(335deg, #16335e 23px, transparent 23px)",
          "linear-gradient(155deg, #16335e 23px, transparent 23px)",
        ].join(", "),
        backgroundSize: "auto, 58px 58px, 58px 58px, 58px 58px, 58px 58px",
        backgroundPosition: "center, 0px 2px, 4px 35px, 29px 31px, 34px 6px",
    ...
    >
      <style>{`
        ...
        .gf label {
          ...
          pointer-events: none;
          /* solid bg matching the blended card color — paints over the border */
          background: transparent;
          padding: 0 5px;
          line-height: 1;
          white-space: nowrap;
        ...
        .gf input:not(:placeholder-shown) ~ label {
          ...
          transform: translateY(-50%);
          font-size: 0.82rem;
          /* #172b4a is the exact blended render of rgba(255,255,255,0.05) over #0b2040 */
          background: #172b4a;
          padding: 0 6px;
        ...
        /* Amber tint while actively focused */
        .gf input:focus ~ label {
      ...
      <div
        ...
        style={{ marginBottom: -80, zIndex: 1, pointerEvents: "none" }}
      >
      ...
      >
        <h1
          ...
          style={{ textShadow: "0 0 10px rgba(255,214,145,0.35)" }}
        >
          Login
        </h1>
