...
void main() {
  ...
  gl_FragColor = color;
      ...
      const uniforms = {
        ...
        iSpeed: { value: speed }, iRayColor1: { value: hexToRgb(rayColor1) },
        iRayColor2: { value: hexToRgb(rayColor2) }, iIntensity: { value: intensity },
        iSpread: { value: spread }, iFlipX: { value: flipX }, iFlipY: { value: flipY },
        iTilt: { value: tilt }, iSaturation: { value: saturation },
  ...
  useEffect(() => {
    ...
    u.iTilt.value = tilt; u.iSaturation.value = saturation;
